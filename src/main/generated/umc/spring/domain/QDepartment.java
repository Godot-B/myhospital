...
public class QDepartment extends EntityPathBase<Department> {
    ...
    private static final long serialVersionUID = -111272706L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QDepartment department = new QDepartment("department");

    public final ListPath<Doctor, QDoctor> doctorList = this.<Doctor, QDoctor>createList("doctorList", Doctor.class, QDoctor.class, PathInits.DIRECT2);
